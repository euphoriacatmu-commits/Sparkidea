...
内景 场景名称 · 白天（或：外景 场景名称 · 夜晚/黄昏/清晨/凌晨）
...
【格式说明（全部使用中文，禁止使用英文术语）】
- 内景：室内场景，外景：室外场景
- 时间：白天 / 夜晚 / 黄昏 / 清晨 / 凌晨
- 画外音：角色不在画面中说话，写法：角色名（画外音）
- 内心独白：叙事旁白，写法：旁白（内心独白）
- △（场景切换）：快速剪辑过渡，单独一行
- 淡入 / 淡出：集首尾使用
- （续）：同一角色在同一场景连续对话
...
2. 反转：本集至少2个，「情理之中、意料之外」，事后感觉必然
3. 结尾钩子：情绪未解决，不是情节未解决，让人「必须」看下一集
4. 道德灰区：不让观众确定谁对谁错，为评论区争议留空间
